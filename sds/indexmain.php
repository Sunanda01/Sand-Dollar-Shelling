...
<body bgcolor="black">
	...
	<a href="sign.php"><button  style="font-size:20px;background-color: rgb(37, 122, 179);height:50px;width: 120px;color:yellow;font-weight: bold;cursor:pointer">SignUp <i class="fas fa-user-plus"></i></button></a>       
	<a href="login.php"><button  style="font-size:20px;background-color: rgb(37, 122, 179);height:50px;width: 120px;cursor:pointer; color:yellow;font-weight: bold;">LogIn <i class="fas fa-sign-in-alt"></i></button></a>
                ...
                <!-- Do you need a working HTML contact form?
                    ...
                    <form id="contact-form" action="" method="POST" class="tm-contact-form" onsubmit="return validate()">
                        <div class="form-group">
                            <input type="text" name="name" class="form-control rounded-0" placeholder="Full Name" required disabled/>
                        </div>
                        <div class="form-group">
                            <input type="email" name="email" class="form-control rounded-0" placeholder="Email" required disabled/>
                        </div>
                        <div class="form-group">
                            <select class="form-control" id="contact-select" name="inquiry" disabled>
                        ...
                        <div class="form-group">
                            <textarea rows="8" name="message" class="form-control rounded-0" placeholder="Message" required disabled></textarea>
                        </div>

                        <div class="form-group tm-text-right">
                            <input type="submit" value="Send It Now" style="cursor:no-drop" class="tm-btn tm-btn-primary" name="submit" id="submit" disabled />
                        </div>
</form>
                </div>
